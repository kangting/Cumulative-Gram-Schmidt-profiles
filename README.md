...
Everything the manuscript includes is regenerated by one entry point, and the
result should match what is committed here.
...
but the output tables do not reveal: the tail-adapted decrement and tail
shape, and the leading-run plateau count.
